...
// --- EVEN MORE EUROPEAN CITIES (500+ EXTENSION) ---

  // United Kingdom (Extensive Regional)
  {name:"Bath",country:"United Kingdom",lat:51.3758,lng:-2.3599},
  {name:"Coventry",country:"United Kingdom",lat:52.4068,lng:-1.5197},
  {name:"Bradford",country:"United Kingdom",lat:53.7928,lng:-1.7518},
  {name:"Wakefield",country:"United Kingdom",lat:53.6800,lng:-1.4900},
  {name:"Kingston upon Hull",country:"United Kingdom",lat:53.7676,lng:-0.3274},
  {name:"Swansea",country:"United Kingdom",lat:51.6214,lng:-3.9436},
  {name:"Reading",country:"United Kingdom",lat:51.4543,lng:-0.9781},
  {name:"Middlesbrough",country:"United Kingdom",lat:54.5742,lng:-1.2325},
  {name:"Bournemouth",country:"United Kingdom",lat:50.7192,lng:-1.8795},
  {name:"Bolton",country:"United Kingdom",lat:53.5769,lng:-2.4282},
  {name:"Swindon",country:"United Kingdom",lat:50.7535,lng:-1.7831},
  {name:"Stockport",country:"United Kingdom",lat:53.4084,lng:-2.1493},
  {name:"Slough",country:"United Kingdom",lat:51.5085,lng:-0.5841},
  {name:"York",country:"United Kingdom",lat:53.9590,lng:-1.0815},
  {name:"Rotherham",country:"United Kingdom",lat:53.4300,lng:-1.3570},
  {name:"Cheltenham",country:"United Kingdom",lat:51.9036,lng:-2.0777},
  {name:"Chelmsford",country:"United Kingdom",lat:51.7356,lng:0.4685},
  {name:"Basingstoke",country:"United Kingdom",lat:51.2667,lng:-1.0876},
  {name:"Maidstone",country:"United Kingdom",lat:51.2721,lng:0.5226},
  {name:"Telford",country:"United Kingdom",lat:52.6775,lng:-2.4438},
  {name:"Worcester",country:"United Kingdom",lat:52.1936,lng:-2.2216},
  {name:"Lincoln",country:"United Kingdom",lat:53.2307,lng:-0.5406},
  {name:"Hereford",country:"United Kingdom",lat:52.0565,lng:-2.7160},
  {name:"Chester",country:"United Kingdom",lat:53.1934,lng:-2.8931},
  {name:"Canterbury",country:"United Kingdom",lat:51.2802,lng:1.0789},
  {name:"St Albans",country:"United Kingdom",lat:51.7520,lng:-0.3394},
  {name:"Winchester",country:"United Kingdom",lat:51.0604,lng:-1.3168},
  {name:"Salisbury",country:"United Kingdom",lat:51.0688,lng:-1.7945},
  {name:"Stirling",country:"United Kingdom",lat:56.1165,lng:-3.9369},
  {name:"Perth",country:"United Kingdom",lat:56.3950,lng:-3.4308},
  {name:"Bangor",country:"United Kingdom",lat:53.2274,lng:-4.1293},
  {name:"Truro",country:"United Kingdom",lat:50.2599,lng:-5.0510},

  // Germany (Extensive Regional)
  {name:"Osnabrück",country:"Germany",lat:52.2799,lng:8.0471},
  {name:"Ludwigshafen",country:"Germany",lat:49.4815,lng:8.4353},
  {name:"Leverkusen",country:"Germany",lat:51.0303,lng:6.9843},
  {name:"Oldenburg",country:"Germany",lat:53.1435,lng:8.2146},
  {name:"Darmstadt",country:"Germany",lat:49.8728,lng:8.6512},
  {name:"Heidelberg",country:"Germany",lat:49.3988,lng:8.6724},
  {name:"Herne",country:"Germany",lat:51.5360,lng:7.2274},
  {name:"Neuss",country:"Germany",lat:51.1981,lng:6.6916},
  {name:"Regensburg",country:"Germany",lat:49.0134,lng:12.1016},
  {name:"Paderborn",country:"Germany",lat:51.7189,lng:8.7575},
  {name:"Ingolstadt",country:"Germany",lat:48.7665,lng:11.4258},
  {name:"Würzburg",country:"Germany",lat:49.7940,lng:9.9298},
  {name:"Fürth",country:"Germany",lat:49.4774,lng:10.9900},
  {name:"Ulm",country:"Germany",lat:48.4011,lng:9.9876},
  {name:"Heilbronn",country:"Germany",lat:49.1427,lng:9.2109},
  {name:"Pforzheim",country:"Germany",lat:48.8950,lng:8.6919},
  {name:"Wolfsburg",country:"Germany",lat:52.4227,lng:10.7865},
  {name:"Göttingen",country:"Germany",lat:51.5413,lng:9.9322},
  {name:"Bottrop",country:"Germany",lat:51.5230,lng:6.9244},
  {name:"Reutlingen",country:"Germany",lat:48.4900,lng:9.2100},
  {name:"Koblenz",country:"Germany",lat:50.3569,lng:7.5890},
  {name:"Bremerhaven",country:"Germany",lat:53.5396,lng:8.5809},
  {name:"Recklinghausen",country:"Germany",lat:51.6167,lng:7.2000},
  {name:"Bergisch Gladbach",country:"Germany",lat:50.9915,lng:7.1293},
  {name:"Erlangen",country:"Germany",lat:49.5897,lng:11.0039},
  {name:"Jena",country:"Germany",lat:50.9271,lng:11.5892},
  {name:"Trier",country:"Germany",lat:49.7499,lng:6.6371},
  {name:"Salzgitter",country:"Germany",lat:52.1504,lng:10.3593},
  {name:"Moers",country:"Germany",lat:51.4513,lng:6.6272},
  {name:"Siegen",country:"Germany",lat:50.8744,lng:8.0240},
  {name:"Hildesheim",country:"Germany",lat:52.1508,lng:9.9511},
  {name:"Cottbus",country:"Germany",lat:51.7563,lng:14.3329},

  // France (Extensive Regional)
  {name:"Reims",country:"France",lat:49.2583,lng:4.0317},
  {name:"Avignon",country:"France",lat:43.9493,lng:4.8055},
  {name:"Versailles",country:"France",lat:48.8014,lng:2.1301},
  {name:"Roubaix",country:"France",lat:50.6927,lng:3.1778},
  {name:"Tourcoing",country:"France",lat:50.7239,lng:3.1612},
  {name:"Montreuil",country:"France",lat:48.8623,lng:2.4412},
  {name:"Nanterre",country:"France",lat:48.8924,lng:2.2069},
  {name:"Poitiers",country:"France",lat:46.5802,lng:0.3404},
  {name:"Créteil",country:"France",lat:48.7771,lng:2.4531},
  {name:"Courbevoie",country:"France",lat:48.8953,lng:2.2561},
  {name:"Vitry-sur-Seine",country:"France",lat:48.7876,lng:2.3928},
  {name:"Colombes",country:"France",lat:48.9229,lng:2.2542},
  {name:"Pau",country:"France",lat:43.2951,lng:-0.3708},
  {name:"Antibes",country:"France",lat:43.5804,lng:7.1251},
  {name:"Béziers",country:"France",lat:43.3442,lng:3.2158},
  {name:"Cannes",country:"France",lat:43.5528,lng:7.0174},
  {name:"Calais",country:"France",lat:50.9513,lng:1.8587},
  {name:"Saint-Nazaire",country:"France",lat:47.2736,lng:-2.2137},
  {name:"Colmar",country:"France",lat:48.0794,lng:7.3560},
  {name:"Ajaccio",country:"France",lat:41.9192,lng:8.7386},
  {name:"Bourges",country:"France",lat:47.0810,lng:2.3988},
  {name:"Dunkerque",country:"France",lat:51.0343,lng:2.3768},
  {name:"Perpignan",country:"France",lat:42.6886,lng:2.8948},
  {name:"Mulhouse",country:"France",lat:47.7508,lng:7.3359},
  {name:"Le Mans",country:"France",lat:47.4379,lng:0.4357},
  {name:"Brest",country:"France",lat:48.3904,lng:-4.4860},
  {name:"Valence",country:"France",lat:43.9317,lng:4.8953},
  {name:"Troyes",country:"France",lat:47.2995,lng:4.0782},
  {name:"Lorient",country:"France",lat:47.7483,lng:-3.3703},
  {name:"Montauban",country:"France",lat:44.0181,lng:1.3558},

  // Italy (Extensive Regional)
  {name:"Treviso",country:"Italy",lat:45.6669,lng:12.2430},
  {name:"Varese",country:"Italy",lat:45.8206,lng:8.8251},
  {name:"Como",country:"Italy",lat:45.8081,lng:9.0852},
  {name:"Novara",country:"Italy",lat:45.4469,lng:8.6195},
  {name:"Cremona",country:"Italy",lat:45.1333,lng:10.0333},
  {name:"Pavia",country:"Italy",lat:45.1852,lng:9.1554},
  {name:"Lodi",country:"Italy",lat:45.3136,lng:9.5031},
  {name:"Alessandria",country:"Italy",lat:44.9126,lng:8.6154},
  {name:"Asti",country:"Italy",lat:44.8998,lng:8.2045},
  {name:"Cuneo",country:"Italy",lat:44.3845,lng:7.5427},
  {name:"Savona",country:"Italy",lat:44.3072,lng:8.4812},
  {name:"Caserta",country:"Italy",lat:41.0705,lng:14.3312},
  {name:"Benevento",country:"Italy",lat:41.1297,lng:14.7828},
  {name:"Potenza",country:"Italy",lat:40.6404,lng:15.8056},
  {name:"Matera",country:"Italy",lat:40.6664,lng:16.6043},
  {name:"Cosenza",country:"Italy",lat:39.2983,lng:16.2537},
  {name:"Catanzaro",country:"Italy",lat:38.9098,lng:16.5877},
  {name:"Lecce",country:"Italy",lat:40.3515,lng:18.1750},
  {name:"Brindisi",country:"Italy",lat:40.6327,lng:17.9418},
  {name:"Barletta",country:"Italy",lat:41.3175,lng:16.2798},
  {name:"Lucca",country:"Italy",lat:43.8429,lng:10.5027},
  {name:"Arezzo",country:"Italy",lat:43.4632,lng:11.8798},
  {name:"Pistoia",country:"Italy",lat:43.9333,lng:10.9167},
  {name:"Grosseto",country:"Italy",lat:42.7667,lng:11.1167},
  {name:"Terni",country:"Italy",lat:42.5630,lng:12.6405},
  {name:"Ancona",country:"Italy",lat:43.6158,lng:13.5189},
  {name:"Viterbo",country:"Italy",lat:42.4184,lng:12.1037},
  {name:"Rieti",country:"Italy",lat:42.4042,lng:12.8624},
  {name:"Frosinone",country:"Italy",lat:41.6398,lng:13.3413},
  {name:"Latina",country:"Italy",lat:41.4676,lng:12.9036},
  {name:"Civitavecchia",country:"Italy",lat:42.0924,lng:11.7953},
  {name:"Ragusa",country:"Italy",lat:36.9282,lng:14.7299},
  {name:"Trapani",country:"Italy",lat:38.0176,lng:12.5144},

  // Spain (Extensive Regional)
  {name:"Marbella",country:"Spain",lat:36.5101,lng:-4.8824},
  {name:"Toledo",country:"Spain",lat:39.8628,lng:-4.0273},
  {name:"Ourense",country:"Spain",lat:42.3367,lng:-7.8641},
  {name:"Reus",country:"Spain",lat:41.1561,lng:1.1069},
  {name:"Girona",country:"Spain",lat:41.9794,lng:2.8214},
  {name:"Santiago de Compostela",country:"Spain",lat:42.8782,lng:-8.5448},
  {name:"Cáceres",country:"Spain",lat:39.4753,lng:-6.3724},
  {name:"Badajoz",country:"Spain",lat:38.8794,lng:-6.9706},
  {name:"Salamanca",country:"Spain",lat:42.2662,lng:-5.6638},
  {name:"Léon",country:"Spain",lat:42.5987,lng:-5.5671},
  {name:"Huelva",country:"Spain",lat:36.9265,lng:-6.9447},
  {name:"Jaén",country:"Spain",lat:37.7796,lng:-3.7849},
  {name:"Lleida",country:"Spain",lat:41.6167,lng:0.6222},
  {name:"Tarragona",country:"Spain",lat:41.1189,lng:1.2445},
  {name:"Cuenca",country:"Spain",lat:40.0704,lng:-2.1374},
  {name:"Segovia",country:"Spain",lat:40.9429,lng:-4.1152},
  {name:"Ávila",country:"Spain",lat:40.6543,lng:-4.7001},
  {name:"Palencia",country:"Spain",lat:42.0095,lng:-4.5241},
  {name:"Zamora",country:"Spain",lat:41.5033,lng:-5.7463},
  {name:"Soria",country:"Spain",lat:41.7640,lng:-2.4688},
  {name:"Teruel",country:"Spain",lat:41.3414,lng:-1.1071},
  {name:"Huesca",country:"Spain",lat:41.6401,lng:-0.4079},
  {name:"Melilla",country:"Spain",lat:35.2937,lng:-2.9383},
  {name:"Ceuta",country:"Spain",lat:35.8894,lng:-3.3162},
  {name:"Ibiza",country:"Spain",lat:38.9067,lng:1.4206},
  {name:"Pontevedra",country:"Spain",lat:42.4310,lng:-8.6444},
  {name:"Lorca",country:"Spain",lat:37.6712,lng:-1.7032},

  // Poland (Extensive Regional)
  {name:"Wałbrzych",country:"Poland",lat:50.7714,lng:16.2767},
  {name:"Włocławek",country:"Poland",lat:52.6483,lng:19.0678},
  {name:"Tarnów",country:"Poland",lat:50.0121,lng:20.9858},
  {name:"Chorzów",country:"Poland",lat:50.2976,lng:18.9545},
  {name:"Koszalin",country:"Poland",lat:54.1944,lng:16.1722},
  {name:"Kalisz",country:"Poland",lat:51.7673,lng:18.0853},
  {name:"Legnica",country:"Poland",lat:51.2070,lng:16.1553},
  {name:"Grudziądz",country:"Poland",lat:53.4833,lng:18.7500},
  {name:"Jaworzno",country:"Poland",lat:50.2053,lng:19.2740},
  {name:"Słupsk",country:"Poland",lat:54.4641,lng:17.0287},
  {name:"Jastrzębie-Zdrój",country:"Poland",lat:49.9547,lng:18.5756},
  {name:"Nowy Sącz",country:"Poland",lat:49.6218,lng:20.6971},
  {name:"Jelenia Góra",country:"Poland",lat:50.9044,lng:15.7273},
  {name:"Siedlce",country:"Poland",lat:52.1672,lng:22.2906},
  {name:"Mysłowice",country:"Poland",lat:50.2415,lng:19.1344},
  {name:"Konin",country:"Poland",lat:52.2234,lng:18.2512},
  {name:"Piła",country:"Poland",lat:53.1514,lng:16.7380},
  {name:"Piotrków Trybunalski",country:"Poland",lat:51.4053,lng:19.6930},
  {name:"Inowrocław",country:"Poland",lat:52.7955,lng:18.2604},
  {name:"Lubin",country:"Poland",lat:51.3964,lng:16.2052},

  // Romania (Extensive Regional)
  {name:"Botoșani",country:"Romania",lat:47.7405,lng:26.6600},
  {name:"Suceava",country:"Romania",lat:47.6514,lng:26.2556},
  {name:"Piatra Neamț",country:"Romania",lat:46.9275,lng:26.3708},
  {name:"Târgu Jiu",country:"Romania",lat:45.0333,lng:23.2833},
  {name:"Târgoviște",country:"Romania",lat:44.9254,lng:25.4567},
  {name:"Focșani",country:"Romania",lat:45.6963,lng:27.1869},
  {name:"Bistrița",country:"Romania",lat:47.1332,lng:24.4984},
  {name:"Tulcea",country:"Romania",lat:45.1760,lng:28.7984},
  {name:"Reșița",country:"Romania",lat:45.2974,lng:21.8906},
  {name:"Slatina",country:"Romania",lat:44.4333,lng:24.3667},
  {name:"Călărași",country:"Romania",lat:44.1950,lng:27.3308},
  {name:"Alba Iulia",country:"Romania",lat:46.0667,lng:23.5833},
  {name:"Giurgiu",country:"Romania",lat:43.9000,lng:25.9667},
  {name:"Deva",country:"Romania",lat:45.8833,lng:22.9000},
  {name:"Hunedoara",country:"Romania",lat:45.7500,lng:22.9000},
  {name:"Zalău",country:"Romania",lat:47.1915,lng:23.0560},
  {name:"Sfântu Gheorghe",country:"Romania",lat:45.8667,lng:25.7833},

  // Netherlands (Extensive Regional)
  {name:"Zaanstad",country:"Netherlands",lat:52.4385,lng:4.8142},
  {name:"Zwolle",country:"Netherlands",lat:52.5168,lng:6.0830},
  {name:"Deventer",country:"Netherlands",lat:52.2544,lng:6.1606},
  {name:"Delft",country:"Netherlands",lat:52.0116,lng:4.3571},
  {name:"Alkmaar",country:"Netherlands",lat:52.6324,lng:4.7534},
  {name:"Heerlen",country:"Netherlands",lat:50.8882,lng:5.9795},
  {name:"Venlo",country:"Netherlands",lat:51.3704,lng:6.1697},
  {name:"Leeuwarden",country:"Netherlands",lat:53.2012,lng:5.7999},
  {name:"Hilversum",country:"Netherlands",lat:52.2292,lng:5.1772},
  {name:"Hengelo",country:"Netherlands",lat:52.2658,lng:6.7930},
  {name:"Schiedam",country:"Netherlands",lat:51.9168,lng:4.3942},
  {name:"Roosendaal",country:"Netherlands",lat:51.5308,lng:4.4653},
  {name:"Spijkenisse",country:"Netherlands",lat:51.8453,lng:4.3276},
  {name:"Vlaardingen",country:"Netherlands",lat:51.9125,lng:4.3425},
  {name:"Almelo",country:"Netherlands",lat:52.3556,lng:6.6633},
  {name:"Gouda",country:"Netherlands",lat:52.0116,lng:4.7105},
  {name:"Lelystad",country:"Netherlands",lat:52.5185,lng:5.4714},

  // Belgium (Extensive Regional)
  {name:"Aalst",country:"Belgium",lat:50.9383,lng:4.0392},
  {name:"Hasselt",country:"Belgium",lat:50.9307,lng:5.3325},
  {name:"Sint-Niklaas",country:"Belgium",lat:51.1646,lng:4.1395},
  {name:"Kortrijk",country:"Belgium",lat:50.8280,lng:3.2649},
  {name:"Tournai",country:"Belgium",lat:50.6054,lng:3.3888},
  {name:"Genk",country:"Belgium",lat:50.9650,lng:5.5008},
  {name:"Seraing",country:"Belgium",lat:50.5967,lng:5.5083},
  {name:"Roeselare",country:"Belgium",lat:50.9445,lng:3.1248},
  {name:"Mouscron",country:"Belgium",lat:50.7433,lng:3.2133},
  {name:"Verviers",country:"Belgium",lat:50.5932,lng:5.8624},

  // Switzerland (Extensive Regional)
  {name:"Sion",country:"Switzerland",lat:46.2331,lng:7.3606},
  {name:"Yverdon-les-Bains",country:"Switzerland",lat:46.7785,lng:6.6412},
  {name:"Montreux",country:"Switzerland",lat:46.4312,lng:6.9107},
  {name:"Frauenfeld",country:"Switzerland",lat:47.5562,lng:8.8959},
  {name:"Neuchâtel",country:"Switzerland",lat:46.9930,lng:6.9293},
  {name:"Bellinzona",country:"Switzerland",lat:46.1928,lng:9.0227},
  {name:"Uster",country:"Switzerland",lat:47.3486,lng:8.7188},
  {name:"Aarau",country:"Switzerland",lat:47.3913,lng:8.0452},

  // Austria (Extensive Regional)
  {name:"Steyr",country:"Austria",lat:48.0427,lng:14.4213},
  {name:"Dornbirn",country:"Austria",lat:47.4124,lng:9.7420},
  {name:"Wiener Neustadt",country:"Austria",lat:47.8132,lng:16.2443},
  {name:"Feldkirch",country:"Austria",lat:47.2366,lng:9.5976},
  {name:"Wolfsberg",country:"Austria",lat:46.8322,lng:14.8431},
  {name:"Baden",country:"Austria",lat:48.0069,lng:16.2308},
  {name:"Klosterneuburg",country:"Austria",lat:48.3052,lng:16.3256},

  // Nordics (Sweden, Norway, Denmark, Finland)
  {name:"Karlstad",country:"Sweden",lat:59.3793,lng:13.5036},
  {name:"Växjö",country:"Sweden",lat:56.8790,lng:14.8059},
  {name:"Halmstad",country:"Sweden",lat:56.6745,lng:12.8578},
  {name:"Sundsvall",country:"Sweden",lat:62.3908,lng:17.3069},
  {name:"Östersund",country:"Sweden",lat:63.1792,lng:14.6357},
  {name:"Trollhättan",country:"Sweden",lat:58.2835,lng:12.2858},
  {name:"Luleå",country:"Sweden",lat:65.5848,lng:22.1567},
  {name:"Karlskrona",country:"Sweden",lat:56.1612,lng:15.5869},
  {name:"Kalmar",country:"Sweden",lat:56.6616,lng:16.3616},
  
  {name:"Sandnes",country:"Norway",lat:58.8510,lng:5.7361},
  {name:"Ålesund",country:"Norway",lat:62.4722,lng:6.1549},
  {name:"Tønsberg",country:"Norway",lat:59.2675,lng:10.4076},
  {name:"Bodø",country:"Norway",lat:67.2804,lng:14.4049},
  {name:"Haugesund",country:"Norway",lat:59.4136,lng:5.2680},
  {name:"Larvik",country:"Norway",lat:59.0533,lng:10.0352},
  {name:"Molde",country:"Norway",lat:62.7372,lng:7.1591},
  
  {name:"Horsens",country:"Denmark",lat:55.8606,lng:9.8503},
  {name:"Herning",country:"Denmark",lat:56.1366,lng:8.9723},
  {name:"Roskilde",country:"Denmark",lat:55.6415,lng:12.0804},
  {name:"Næstved",country:"Denmark",lat:55.2299,lng:11.7580},
  {name:"Slagelse",country:"Denmark",lat:55.4028,lng:11.3546},
  
  {name:"Joensuu",country:"Finland",lat:62.6010,lng:29.7636},
  {name:"Lappeenranta",country:"Finland",lat:61.0587,lng:28.1887},
  {name:"Hämeenlinna",country:"Finland",lat:60.9953,lng:24.4643},
  {name:"Seinäjoki",country:"Finland",lat:62.7903,lng:22.8403},
  {name:"Rovaniemi",country:"Finland",lat:66.5039,lng:25.7294},

  // Greece (Extensive Regional & Islands)
  {name:"Rethymno",country:"Greece",lat:35.3670,lng:24.4754},
  {name:"Corinth",country:"Greece",lat:37.9400,lng:22.9328},
  {name:"Giannitsa",country:"Greece",lat:40.7933,lng:22.4080},
  {name:"Mytilene",country:"Greece",lat:39.1066,lng:26.5546},
  {name:"Chios",country:"Greece",lat:38.3678,lng:26.1358},
  {name:"Pyrgos",country:"Greece",lat:37.6749,lng:21.4428},
  {name:"Megara",country:"Greece",lat:38.0016,lng:23.3425},
  {name:"Kilkis",country:"Greece",lat:40.9934,lng:22.8744},
  {name:"Thebes",country:"Greece",lat:38.3183,lng:23.3150},
  {name:"Argos",country:"Greece",lat:37.6333,lng:22.7333},
  {name:"Arta",country:"Greece",lat:39.1611,lng:20.9858},
  {name:"Livadeia",country:"Greece",lat:38.4385,lng:22.8737},
  {name:"Aigio",country:"Greece",lat:38.2514,lng:22.0833},
  {name:"Naousa",country:"Greece",lat:40.6272,lng:22.0683},
  {name:"Orestiada",country:"Greece",lat:41.5031,lng:26.5317},
  {name:"Edessa",country:"Greece",lat:40.8016,lng:22.0469},
  {name:"Florina",country:"Greece",lat:40.7818,lng:21.4098},
  {name:"Amaliada",country:"Greece",lat:37.7968,lng:21.3533},
  {name:"Preveza",country:"Greece",lat:38.9562,lng:20.7516},
  {name:"Sparta",country:"Greece",lat:37.0745,lng:22.4303},
  {name:"Nafpaktos",country:"Greece",lat:38.3931,lng:21.8275},
  {name:"Kastoria",country:"Greece",lat:40.5236,lng:21.2661},
  {name:"Grevena",country:"Greece",lat:40.0839,lng:21.4278},
  {name:"Ierapetra",country:"Greece",lat:35.0101,lng:25.7366},

  // Portugal (Extensive Regional)
  {name:"Cascais",country:"Portugal",lat:38.6979,lng:-9.4215},
  {name:"Loures",country:"Portugal",lat:38.8315,lng:-9.1741},
  {name:"Oeiras",country:"Portugal",lat:38.6969,lng:-9.3146},
  {name:"Seixal",country:"Portugal",lat:38.6406,lng:-9.1065},
  {name:"Odivelas",country:"Portugal",lat:38.7915,lng:-9.1824},
  {name:"Maia",country:"Portugal",lat:41.2279,lng:-8.6210},
  {name:"Santarém",country:"Portugal",lat:39.2367,lng:-8.6860},
  {name:"Portimão",country:"Portugal",lat:37.1384,lng:-8.5367},
  {name:"Viana do Castelo",country:"Portugal",lat:41.6932,lng:-8.8329},
  {name:"Viseu",country:"Portugal",lat:40.6575,lng:-7.9143},

  // Czech Republic (Extensive Regional)
  {name:"Havířov",country:"Czech Republic",lat:49.7788,lng:18.4363},
  {name:"Zlín",country:"Czech Republic",lat:49.2275,lng:17.6628},
  {name:"Kladno",country:"Czech Republic",lat:50.1473,lng:14.1029},
  {name:"Most",country:"Czech Republic",lat:50.5030,lng:13.6362},
  {name:"Karviná",country:"Czech Republic",lat:49.8550,lng:18.5447},
  {name:"Opava",country:"Czech Republic",lat:49.9387,lng:17.9026},
  {name:"Frýdek-Místek",country:"Czech Republic",lat:49.6841,lng:18.3496},
  {name:"Děčín",country:"Czech Republic",lat:50.7816,lng:14.2148},
  {name:"Teplice",country:"Czech Republic",lat:50.6404,lng:13.8245},
  {name:"Karlovy Vary",country:"Czech Republic",lat:50.2319,lng:12.8720},
  {name:"Jihlava",country:"Czech Republic",lat:49.3961,lng:15.5902},

  // Slovakia (Extensive Regional)
  {name:"Poprad",country:"Slovakia",lat:49.0560,lng:20.3000},
  {name:"Zvolen",country:"Slovakia",lat:48.5772,lng:19.1275},
  {name:"Považská Bystrica",country:"Slovakia",lat:49.1154,lng:18.4414},
  {name:"Nové Zámky",country:"Slovakia",lat:47.9862,lng:18.1633},
  {name:"Michalovce",country:"Slovakia",lat:48.7516,lng:21.9168},
  {name:"Spišská Nová Ves",country:"Slovakia",lat:48.9446,lng:20.5615},
  {name:"Komárno",country:"Slovakia",lat:47.7635,lng:18.1226},
  {name:"Levice",country:"Slovakia",lat:48.2156,lng:18.6071},

  // Hungary (Extensive Regional)
  {name:"Veszprém",country:"Hungary",lat:47.0933,lng:17.9115},
  {name:"Érd",country:"Hungary",lat:47.3800,lng:18.9133},
  {name:"Zalaegerszeg",country:"Hungary",lat:46.8400,lng:16.8439},
  {name:"Szolnok",country:"Hungary",lat:47.1736,lng:20.1979},
  {name:"Dunaújváros",country:"Hungary",lat:46.9634,lng:18.9351},
  {name:"Tatabánya",country:"Hungary",lat:47.5813,lng:18.3976},
  {name:"Sopron",country:"Hungary",lat:47.6833,lng:16.5833},
  {name:"Kaposvár",country:"Hungary",lat:46.3639,lng:17.7817},
  {name:"Békéscsaba",country:"Hungary",lat:46.6800,lng:21.0975},
  {name:"Eger",country:"Hungary",lat:46.9000,lng:21.2833}, // Correcting Gyula/Eger approximations
  {name:"Hódmezővásárhely",country:"Hungary",lat:46.4300,lng:20.3189},
...
// --- MORE ASIAN CITIES ---
  ...
  {name:"Foshan",country:"China",lat:23.0215,lng:113.1214},
  ...
  {name:"Changchun",country:"China",lat:43.8171,lng:125.3235},
  {name:"Shijiazhuang",country:"China",lat:38.0428,lng:114.5149},
  {name:"Changsha",country:"China",lat:28.2282,lng:112.9388},
  {name:"Kunming",country:"China",lat:25.0453,lng:102.7100},
  {name:"Wuxi",country:"China",lat:31.4912,lng:120.3119},
  {name:"Zhengzhou",country:"China",lat:34.7466,lng:113.6253},
  {name:"Ningbo",country:"China",lat:29.8683,lng:121.5440},
  {name:"Nanning",country:"China",lat:22.8170,lng:108.3665},
  {name:"Hefei",country:"China",lat:31.8206,lng:117.2272},
  {name:"Taiyuan",country:"China",lat:37.8706,lng:112.5507},
  {name:"Tangshan",country:"China",lat:39.6309,lng:118.1802},
  {name:"Wenzhou",country:"China",lat:27.9943,lng:120.6994},
  {name:"Fuzhou",country:"China",lat:26.0745,lng:119.2965},
  {name:"Changzhou",country:"China",lat:31.8112,lng:119.9740},
  {name:"Nanchang",country:"China",lat:28.6820,lng:115.8579},
  {name:"Guiyang",country:"China",lat:26.6470,lng:106.6302},
  {name:"Lanzhou",country:"China",lat:36.0611,lng:103.8343},
  {name:"Hohhot",country:"China",lat:40.8423,lng:111.7492},
  {name:"Urumqi",country:"China",lat:43.8256,lng:87.6169},
  {name:"Yantai",country:"China",lat:37.4646,lng:121.4480},
  {name:"Luoyang",country:"China",lat:34.6190,lng:112.4540},
  {name:"Nantong",country:"China",lat:32.0162,lng:120.8753},
  {name:"Baotou",country:"China",lat:40.6522,lng:109.8222},

  // India (Additional)
  {name:"Thane",country:"India",lat:19.1970,lng:72.9635},
  {name:"Visakhapatnam",country:"India",lat:17.6868,lng:83.2185},
  {name:"Pimpri-Chinchwad",country:"India",lat:18.6298,lng:73.7997},
  {name:"Ghaziabad",country:"India",lat:28.6692,lng:77.4538},
  {name:"Ludhiana",country:"India",lat:30.9010,lng:75.8573},
  {name:"Nashik",country:"India",lat:20.0059,lng:73.7629},
  {name:"Faridabad",country:"India",lat:28.4089,lng:77.3178},
  {name:"Meerut",country:"India",lat:28.9845,lng:77.7064},
  {name:"Rajkot",country:"India",lat:22.3039,lng:70.8022},
  {name:"Kalyan-Dombivli",country:"India",lat:19.2372,lng:73.1360},
  {name:"Vasai-Virar",country:"India",lat:19.3919,lng:72.8397},
  {name:"Srinagar",country:"India",lat:34.0837,lng:74.7973},
  {name:"Aurangabad",country:"India",lat:19.8762,lng:75.3433},
  {name:"Dhanbad",country:"India",lat:23.7915,lng:86.4304},
  {name:"Navi Mumbai",country:"India",lat:19.0330,lng:73.0297},
  {name:"Prayagraj",country:"India",lat:25.4358,lng:81.8463}, // Allahabad
  {name:"Howrah",country:"India",lat:22.5958,lng:88.3110},
  {name:"Ranchi",country:"India",lat:23.3441,lng:85.3096},
  {name:"Gwalior",country:"India",lat:26.2183,lng:78.1828},
  {name:"Jabalpur",country:"India",lat:23.1815,lng:79.9864},
  {name:"Coimbatore",country:"India",lat:11.0168,lng:76.9558},
  {name:"Vijayawada",country:"India",lat:16.5062,lng:80.6480},
  {name:"Jodhpur",country:"India",lat:26.2389,lng:73.0243},
  {name:"Madurai",country:"India",lat:9.9252,lng:78.1198},
  {name:"Raipur",country:"India",lat:21.2514,lng:81.6296},
  {name:"Kota",country:"India",lat:25.2138,lng:75.8648},
  ...
  {name:"Hubli-Dharwad",country:"India",lat:15.3647,lng:75.1240},

  // Japan (Additional)
  {name:"Kawasaki",country:"Japan",lat:35.5308,lng:139.7029},
  {name:"Kitakyushu",country:"Japan",lat:33.8833,lng:130.8833},
  {name:"Chiba",country:"Japan",lat:35.6073,lng:140.1063},
  {name:"Sakai",country:"Japan",lat:34.5733,lng:135.4831},
  {name:"Niigata",country:"Japan",lat:37.9161,lng:139.0364},
  {name:"Hamamatsu",country:"Japan",lat:34.7108,lng:137.7261},
  {name:"Kumamoto",country:"Japan",lat:32.8031,lng:130.7079},
  {name:"Sagamihara",country:"Japan",lat:35.5714,lng:139.3732},
  {name:"Shizuoka",country:"Japan",lat:34.9756,lng:138.3828},
  {name:"Okayama",country:"Japan",lat:34.6551,lng:133.9195},
  {name:"Kagoshima",country:"Japan",lat:31.5966,lng:130.5571},
  {name:"Funabashi",country:"Japan",lat:35.6947,lng:139.9826},
  {name:"Hachioji",country:"Japan",lat:35.6586,lng:139.3241},
  {name:"Himeji",country:"Japan",lat:34.8151,lng:134.6853},
  {name:"Matsuyama",country:"Japan",lat:33.8392,lng:132.7652},
  {name:"Utsunomiya",country:"Japan",lat:36.5551,lng:139.8826},
  {name:"Higashiosaka",country:"Japan",lat:34.6793,lng:135.6012},
  {name:"Kawaguchi",country:"Japan",lat:35.8078,lng:139.7246},
  {name:"Matsudo",country:"Japan",lat:35.7844,lng:139.9031},
  {name:"Kurashiki",country:"Japan",lat:34.5833,lng:133.7667},

  // Indonesia (Additional)
  {name:"Bekasi",country:"Indonesia",lat:-6.2383,lng:106.9756},
  {name:"Tangerang",country:"Indonesia",lat:-6.1783,lng:106.6319},
  {name:"Depok",country:"Indonesia",lat:-6.4025,lng:106.7942},
  {name:"South Tangerang",country:"Indonesia",lat:-6.2886,lng:106.7179},
  {name:"Batam",country:"Indonesia",lat:1.1301,lng:104.0529},
  {name:"Pekanbaru",country:"Indonesia",lat:0.5071,lng:101.4478},
  {name:"Bogor",country:"Indonesia",lat:-6.5971,lng:106.7915},
  {name:"Padang",country:"Indonesia",lat:-0.9471,lng:100.3588},
  {name:"Bandar Lampung",country:"Indonesia",lat:-5.4500,lng:105.2667},
  {name:"Tasikmalaya",country:"Indonesia",lat:-7.3274,lng:108.2142},
  {name:"Pontianak",country:"Indonesia",lat:-0.0227,lng:109.3353},
  {name:"Banjarmasin",country:"Indonesia",lat:-3.3167,lng:114.5901},
  {name:"Balikpapan",country:"Indonesia",lat:-1.2654,lng:116.8312},
  {name:"Jambi",country:"Indonesia",lat:-1.6111,lng:103.6167},
  {name:"Surakarta",country:"Indonesia",lat:-7.5561,lng:110.8317},
  {name:"Manado",country:"Indonesia",lat:1.4931,lng:124.8413},
  {name:"Kupang",country:"Indonesia",lat:-10.1583,lng:123.5833},
  {name:"Jayapura",country:"Indonesia",lat:-2.5333,lng:140.7167},
  {name:"Mataram",country:"Indonesia",lat:-8.5833,lng:116.1167},
  {name:"Yogyakarta",country:"Indonesia",lat:-7.7956,lng:110.3695},

  // Philippines (Additional)
  {name:"Caloocan",country:"Philippines",lat:14.6500,lng:120.9833},
  {name:"Makati",country:"Philippines",lat:14.5547,lng:121.0244},
  {name:"Pasig",country:"Philippines",lat:14.5764,lng:121.0851},
  {name:"Taguig",country:"Philippines",lat:14.5176,lng:121.0509},
  {name:"Antipolo",country:"Philippines",lat:14.5900,lng:121.1763},
  {name:"Pasay",country:"Philippines",lat:14.5378,lng:120.9993},
  {name:"Valenzuela",country:"Philippines",lat:14.7000,lng:120.9833},
  {name:"Dasmariñas",country:"Philippines",lat:14.3294,lng:120.9367},
  {name:"General Santos",country:"Philippines",lat:6.1167,lng:125.1667},
  {name:"Bacoor",country:"Philippines",lat:14.4561,lng:120.9392},
  {name:"San Jose del Monte",country:"Philippines",lat:14.8146,lng:121.0483},
  {name:"Iloilo City",country:"Philippines",lat:10.7202,lng:122.5621},
  {name:"Las Piñas",country:"Philippines",lat:14.4442,lng:120.9939},
  {name:"Bacolod",country:"Philippines",lat:10.6667,lng:122.9500},
  {name:"Muntinlupa",country:"Philippines",lat:14.3931,lng:121.0425},
  {name:"Lapu-Lapu",country:"Philippines",lat:10.3106,lng:123.9489},
  {name:"Imus",country:"Philippines",lat:14.4297,lng:120.9367},
  {name:"Mandaue",country:"Philippines",lat:10.3333,lng:123.9333},
  {name:"Baguio",country:"Philippines",lat:16.4164,lng:120.5931},
  {name:"Angeles",country:"Philippines",lat:15.1444,lng:120.5889},

  // South Korea (Additional)
  {name:"Changwon",country:"South Korea",lat:35.2281,lng:128.6811},
  {name:"Goyang",country:"South Korea",lat:37.6583,lng:126.8320},
  {name:"Yongin",country:"South Korea",lat:37.2378,lng:127.1973},
  {name:"Seongnam",country:"South Korea",lat:37.4200,lng:127.1265},
  {name:"Bucheon",country:"South Korea",lat:37.5034,lng:126.7660},
  {name:"Cheongju",country:"South Korea",lat:36.6424,lng:127.4890},
  {name:"Ansan",country:"South Korea",lat:37.3219,lng:126.8308},
  {name:"Jeonju",country:"South Korea",lat:35.8242,lng:127.1480},
  {name:"Cheonan",country:"South Korea",lat:36.8151,lng:127.1139},
  {name:"Namyangju",country:"South Korea",lat:37.6360,lng:127.2165},
  {name:"Hwaseong",country:"South Korea",lat:37.1995,lng:126.8315},
  {name:"Anyang",country:"South Korea",lat:37.3943,lng:126.9568},
  {name:"Gimhae",country:"South Korea",lat:35.2285,lng:128.8894},
  {name:"Pohang",country:"South Korea",lat:36.0190,lng:129.3435},
  {name:"Pyeongtaek",country:"South Korea",lat:36.9921,lng:127.1129},
  {name:"Jeju",country:"South Korea",lat:33.4996,lng:126.5312},

  // Turkey (Asian Part - Additional)
  {name:"Mersin",country:"Turkey",lat:36.8000,lng:34.6333},
  ...
  {name:"Kahramanmaraş",country:"Turkey",lat:37.5847,lng:36.9264},
  ...
  {name:"Elazığ",country:"Turkey",lat:38.6748,lng:39.2225},
  {name:"Batman",country:"Turkey",lat:37.8812,lng:41.1351},
  {name:"Sivas",country:"Turkey",lat:39.7477,lng:37.0179},
  {name:"Manisa",country:"Turkey",lat:38.6140,lng:27.4296},
  {name:"İzmit",country:"Turkey",lat:40.7669,lng:29.9169}, // Kocaeli
  {name:"Balıkesir",country:"Turkey",lat:39.6484,lng:27.8826},
  {name:"Trabzon",country:"Turkey",lat:41.0027,lng:39.7168},

  // Iran (Additional)
  {name:"Kermanshah",country:"Iran",lat:34.3142,lng:47.0650},
  {name:"Urmia",country:"Iran",lat:37.5527,lng:45.0761},
  {name:"Rasht",country:"Iran",lat:37.2808,lng:49.5832},
  {name:"Zahedan",country:"Iran",lat:29.4963,lng:60.8629},
  {name:"Hamadan",country:"Iran",lat:34.7982,lng:48.5146},
  {name:"Kerman",country:"Iran",lat:30.2839,lng:57.0806},
  {name:"Yazd",country:"Iran",lat:31.8974,lng:54.3675},
  {name:"Ardabil",country:"Iran",lat:38.2498,lng:48.2933},
  {name:"Bandar Abbas",country:"Iran",lat:27.1832,lng:56.2666},
  {name:"Arak",country:"Iran",lat:34.0954,lng:49.7013},
  {name:"Zanjan",country:"Iran",lat:36.6736,lng:48.4787},
  {name:"Sanandaj",country:"Iran",lat:35.3219,lng:46.9960},
  {name:"Qazvin",country:"Iran",lat:36.2668,lng:50.0038},
  {name:"Khorramabad",country:"Iran",lat:33.4871,lng:48.3538},
  {name:"Gorgan",country:"Iran",lat:36.8300,lng:54.4333},

  // Pakistan (Additional)
  {name:"Gujranwala",country:"Pakistan",lat:32.1617,lng:74.1883},
  {name:"Sargodha",country:"Pakistan",lat:32.0836,lng:72.6711},
  {name:"Sialkot",country:"Pakistan",lat:32.4945,lng:74.5229},
  {name:"Bahawalpur",country:"Pakistan",lat:29.3956,lng:71.6833},
  {name:"Sukkur",country:"Pakistan",lat:27.7111,lng:68.8592},
  {name:"Jhang",country:"Pakistan",lat:31.2681,lng:72.3181},
  {name:"Sheikhupura",country:"Pakistan",lat:31.7167,lng:73.9850},
  {name:"Mardan",country:"Pakistan",lat:34.1958,lng:72.0447},
  {name:"Gujrat",country:"Pakistan",lat:32.5736,lng:74.0789},
  {name:"Larkana",country:"Pakistan",lat:27.5590,lng:68.2228},
  {name:"Kasur",country:"Pakistan",lat:31.1167,lng:74.4500},
  {name:"Rahim Yar Khan",country:"Pakistan",lat:28.4212,lng:70.2989},
  {name:"Sahiwal",country:"Pakistan",lat:30.6682,lng:73.1114},
  {name:"Okara",country:"Pakistan",lat:30.8081,lng:73.4458},

  // Vietnam (Additional)
  {name:"Nha Trang",country:"Vietnam",lat:12.2388,lng:109.1967},
  {name:"Buon Ma Thuot",country:"Vietnam",lat:12.6667,lng:108.0500},
  {name:"Vinh",country:"Vietnam",lat:18.6667,lng:105.6667},
  {name:"Vung Tau",country:"Vietnam",lat:10.3460,lng:107.0843},
  {name:"Quy Nhon",country:"Vietnam",lat:13.7761,lng:109.2217},
  {name:"Long Xuyen",country:"Vietnam",lat:10.3712,lng:105.4326},
  {name:"Thai Nguyen",country:"Vietnam",lat:21.5928,lng:105.8442},
  {name:"Nam Dinh",country:"Vietnam",lat:20.4333,lng:106.1667},
  {name:"Rach Gia",country:"Vietnam",lat:10.0167,lng:105.0833},
  {name:"Thu Dau Mot",country:"Vietnam",lat:10.9804,lng:106.6519},
  {name:"Ha Long",country:"Vietnam",lat:20.9505,lng:107.0734},
  {name:"Phan Thiet",country:"Vietnam",lat:10.9333,lng:108.1000},
  {name:"Thanh Hoa",country:"Vietnam",lat:19.8067,lng:105.7714},

  // Malaysia (Additional)
  {name:"Shah Alam",country:"Malaysia",lat:3.0738,lng:101.5183},
  {name:"Petaling Jaya",country:"Malaysia",lat:3.1073,lng:101.6067},
  {name:"Subang Jaya",country:"Malaysia",lat:3.0567,lng:101.5856},
  {name:"Klang",country:"Malaysia",lat:3.0333,lng:101.4500},
  {name:"Malacca City",country:"Malaysia",lat:2.1896,lng:102.2501},
  {name:"Alor Setar",country:"Malaysia",lat:6.1210,lng:100.3667},
  {name:"Miri",country:"Malaysia",lat:4.4148,lng:114.0089},
  {name:"Seremban",country:"Malaysia",lat:2.7297,lng:101.9381},
  {name:"Kuantan",country:"Malaysia",lat:3.8167,lng:103.3333},
  {name:"Tawau",country:"Malaysia",lat:4.2498,lng:117.8871},
  {name:"Sandakan",country:"Malaysia",lat:5.8402,lng:118.1179},
  {name:"Batu Pahat",country:"Malaysia",lat:1.8548,lng:102.9325},

  // Russia (Asian Part / Siberia - Additional)
  {name:"Barnaul",country:"Russia",lat:53.3468,lng:83.7769},
  {name:"Tyumen",country:"Russia",lat:57.1522,lng:65.5272},
  {name:"Tomsk",country:"Russia",lat:56.4977,lng:84.9744},
  {name:"Kemerovo",country:"Russia",lat:55.3333,lng:86.0833},
  {name:"Novokuznetsk",country:"Russia",lat:53.7557,lng:87.1361},
  {name:"Khabarovsk",country:"Russia",lat:48.4827,lng:135.0838},
  {name:"Ulan-Ude",country:"Russia",lat:51.8344,lng:107.5845},
  {name:"Chita",country:"Russia",lat:52.0333,lng:113.5500},
  {name:"Yakutsk",country:"Russia",lat:62.0355,lng:129.6755},
  {name:"Magnitogorsk",country:"Russia",lat:53.4114,lng:59.0494}, // Borderline Urals/Asia
  {name:"Surgut",country:"Russia",lat:61.2500,lng:73.4167},
  {name:"Nizhnevartovsk",country:"Russia",lat:60.9333,lng:76.5667},

  // Saudi Arabia (Additional)
  {name:"Buraydah",country:"Saudi Arabia",lat:26.3260,lng:43.9750},
  {name:"Khamis Mushait",country:"Saudi Arabia",lat:18.3000,lng:42.7333},
  {name:"Abha",country:"Saudi Arabia",lat:18.2164,lng:42.5053},
  {name:"Al Hofuf",country:"Saudi Arabia",lat:25.3787,lng:49.5866},
  {name:"Ha'il",country:"Saudi Arabia",lat:27.5219,lng:41.6907},
  {name:"Najran",country:"Saudi Arabia",lat:17.4933,lng:44.1277},
  {name:"Al Jubail",country:"Saudi Arabia",lat:27.0112,lng:49.6583},
  {name:"Yanbu",country:"Saudi Arabia",lat:24.0891,lng:38.0637},
  {name:"Qatif",country:"Saudi Arabia",lat:26.5583,lng:49.0069},

  // Iraq (Additional)
  {name:"Sulaymaniyah",country:"Iraq",lat:35.5606,lng:45.4380},
  {name:"Hillah",country:"Iraq",lat:32.4800,lng:44.4300},
  {name:"Amarah",country:"Iraq",lat:31.8315,lng:47.1448},
  {name:"Nasiriyah",country:"Iraq",lat:31.0583,lng:46.2583},
  {name:"Baqubah",country:"Iraq",lat:33.7466,lng:44.6251},
  {name:"Diwaniyah",country:"Iraq",lat:31.9868,lng:44.9216},
  {name:"Ramadi",country:"Iraq",lat:33.4302,lng:43.2981},
  {name:"Kut",country:"Iraq",lat:32.5042,lng:45.8236},
  {name:"Dohuk",country:"Iraq",lat:36.8665,lng:42.9896},
  {name:"Fallujah",country:"Iraq",lat:33.3444,lng:43.7848},

  // Taiwan (Additional)
  {name:"Taoyuan",country:"Taiwan",lat:24.9936,lng:121.3010},
  {name:"Hsinchu",country:"Taiwan",lat:24.8138,lng:120.9675},
  {name:"Keelung",country:"Taiwan",lat:25.1276,lng:121.7392},
  {name:"Chiayi",country:"Taiwan",lat:23.4791,lng:120.4414},
  {name:"Changhua",country:"Taiwan",lat:24.0816,lng:120.5385},
  {name:"Pingtung",country:"Taiwan",lat:22.6728,lng:120.4878},
  {name:"Zhubei",country:"Taiwan",lat:24.8314,lng:121.0120},
  {name:"Hualien",country:"Taiwan",lat:23.9769,lng:121.6044},
  {name:"Taitung",country:"Taiwan",lat:22.7583,lng:121.1444},

  // Kazakhstan (Additional)
  {name:"Taraz",country:"Kazakhstan",lat:42.9000,lng:71.3667},
  {name:"Pavlodar",country:"Kazakhstan",lat:52.3000,lng:76.9500},
  {name:"Oskemen",country:"Kazakhstan",lat:49.9483,lng:82.6278},
  {name:"Semey",country:"Kazakhstan",lat:50.4111,lng:80.2275},
  {name:"Atyrau",country:"Kazakhstan",lat:47.1167,lng:51.8833},
  {name:"Kostanay",country:"Kazakhstan",lat:53.2144,lng:63.6246},
  {name:"Kyzylorda",country:"Kazakhstan",lat:44.8528,lng:65.5097},
  {name:"Uralsk",country:"Kazakhstan",lat:51.2333,lng:51.3667},
  {name:"Petropavl",country:"Kazakhstan",lat:54.8728,lng:69.1431},
  {name:"Aktau",country:"Kazakhstan",lat:43.6500,lng:51.2000},

  // Uzbekistan (Additional)
  {name:"Andijan",country:"Uzbekistan",lat:40.7833,lng:72.3333},
  {name:"Nukus",country:"Uzbekistan",lat:42.4667,lng:59.6167},
  {name:"Fergana",country:"Uzbekistan",lat:40.3833,lng:71.7833},
  {name:"Qarshi",country:"Uzbekistan",lat:38.8667,lng:65.8000},
  {name:"Kokand",country:"Uzbekistan",lat:40.5333,lng:70.9333},
  {name:"Margilan",country:"Uzbekistan",lat:40.4833,lng:71.7167},
  {name:"Navoiy",country:"Uzbekistan",lat:40.0844,lng:65.3792},
  {name:"Urgench",country:"Uzbekistan",lat:41.5500,lng:60.6333},
  {name:"Jizzakh",country:"Uzbekistan",lat:40.1167,lng:67.8333},

  // Bangladesh (Additional)
  {name:"Comilla",country:"Bangladesh",lat:23.4607,lng:91.1809},
  {name:"Bogra",country:"Bangladesh",lat:24.8481,lng:89.3730},
  {name:"Mymensingh",country:"Bangladesh",lat:24.7471,lng:90.4203},
  {name:"Barisal",country:"Bangladesh",lat:22.7010,lng:90.3535},
  {name:"Rangpur",country:"Bangladesh",lat:25.7439,lng:89.2752},
  {name:"Jessore",country:"Bangladesh",lat:23.1634,lng:89.2182},
  {name:"Cox's Bazar",country:"Bangladesh",lat:21.4272,lng:92.0058},
  {name:"Brahmanbaria",country:"Bangladesh",lat:23.9571,lng:91.1119},
  {name:"Dinajpur",country:"Bangladesh",lat:25.6279,lng:88.6332},

  // Israel (Additional)
  {name:"Netanya",country:"Israel",lat:32.3271,lng:34.8568},
  {name:"Beersheba",country:"Israel",lat:31.2518,lng:34.7913},
  {name:"Holon",country:"Israel",lat:32.0158,lng:34.7874},
  {name:"Bnei Brak",country:"Israel",lat:32.0833,lng:34.8333},
  {name:"Ramat Gan",country:"Israel",lat:32.0684,lng:34.8248},
  {name:"Rehovot",country:"Israel",lat:31.8948,lng:34.8113},
  {name:"Bat Yam",country:"Israel",lat:32.0167,lng:34.7500},
  {name:"Ashkelon",country:"Israel",lat:31.6693,lng:34.5715},

  // Thailand (Additional)
  {name:"Nonthaburi",country:"Thailand",lat:13.8591,lng:100.5217},
  {name:"Pak Kret",country:"Thailand",lat:13.9133,lng:100.4989},
  {name:"Surat Thani",country:"Thailand",lat:9.1382,lng:99.3216},
  {name:"Udon Thani",country:"Thailand",lat:17.4118,lng:102.7937},
  {name:"Khon Kaen",country:"Thailand",lat:16.4287,lng:102.8336},
  {name:"Ubon Ratchathani",country:"Thailand",lat:15.2287,lng:104.8570},
  {name:"Nakhon Si Thammarat",country:"Thailand",lat:8.4333,lng:99.9667},
  {name:"Chiang Rai",country:"Thailand",lat:19.9079,lng:99.8272},

  // Sri Lanka (Additional)
  {name:"Jaffna",country:"Sri Lanka",lat:9.6615,lng:80.0255},
  {name:"Negombo",country:"Sri Lanka",lat:7.2008,lng:79.8737},
  {name:"Trincomalee",country:"Sri Lanka",lat:8.5711,lng:81.2335},
  {name:"Anuradhapura",country:"Sri Lanka",lat:8.3114,lng:80.4037},
  {name:"Batticaloa",country:"Sri Lanka",lat:7.7310,lng:81.6747},
  {name:"Moratuwa",country:"Sri Lanka",lat:6.7730,lng:79.8816},

  // Nepal (Additional)
  {name:"Biratnagar",country:"Nepal",lat:26.4525,lng:87.2831},
  {name:"Bharatpur",country:"Nepal",lat:27.6833,lng:84.4333},
  {name:"Birgunj",country:"Nepal",lat:27.0139,lng:84.8778},
  {name:"Dharan",country:"Nepal",lat:26.8125,lng:87.2835},
  {name:"Butwal",country:"Nepal",lat:27.6970,lng:83.4549},
  {name:"Janakpur",country:"Nepal",lat:26.7288,lng:85.9250},
...
// ================= MORE NORTH AMERICA (CANADA, USA, GREENLAND) =================
